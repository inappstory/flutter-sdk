...
data class GoodsItemDataDto (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return PigeonGeneratedPigeonUtils.deepEquals(this.sku, other.sku) && PigeonGeneratedPigeonUtils.deepEquals(this.title, other.title) && PigeonGeneratedPigeonUtils.deepEquals(this.description, other.description) && PigeonGeneratedPigeonUtils.deepEquals(this.image, other.image) && PigeonGeneratedPigeonUtils.deepEquals(this.price, other.price) && PigeonGeneratedPigeonUtils.deepEquals(this.oldPrice, other.oldPrice)
  }
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + PigeonGeneratedPigeonUtils.deepHash(this.title)
    result = 31 * result + PigeonGeneratedPigeonUtils.deepHash(this.description)
