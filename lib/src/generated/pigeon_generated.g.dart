...
class StoryAPIDataDto {
  ...
  @override
  String toString() {
    return 'StoryAPIDataDto(id: $id, storyData: $storyData, imageFilePath: $imageFilePath, videoFilePath: $videoFilePath, hasAudio: $hasAudio, title: $title, titleColor: $titleColor, backgroundColor: $backgroundColor, opened: $opened, aspectRatio: $aspectRatio)';
  }
}
...
class SlideDataDto {
  ...
  @override
  String toString() {
    return 'SlideDataDto(story: $story, index: $index, payload: $payload)';
  }
}
...
class GoodsItemAppearanceDto {
  ...
  @override
  String toString() {
    return 'GoodsItemAppearanceDto(itemBackgroundColor: $itemBackgroundColor, itemCornerRadius: $itemCornerRadius, itemMainTextColor: $itemMainTextColor, itemOldPriceTextColor: $itemOldPriceTextColor, itemTitleTextSize: $itemTitleTextSize, itemDescriptionTextSize: $itemDescriptionTextSize, itemPriceTextSize: $itemPriceTextSize, itemOldPriceTextSize: $itemOldPriceTextSize, widgetBackgroundColor: $widgetBackgroundColor, closeButtonImage: $closeButtonImage, closeButtonColor: $closeButtonColor, widgetBackgroundHeight: $widgetBackgroundHeight)';
  }
}
...
class GoodsItemDataDto {
  ...
  static GoodsItemDataDto decode(Object result) {
    ...
    return GoodsItemDataDto(
      ...
      title: result[1] as String?,
      productDescription: result[2] as String?,
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(sku, other.sku) && _deepEquals(title, other.title) && _deepEquals(productDescription, other.productDescription) && _deepEquals(image, other.image) && _deepEquals(price, other.price) && _deepEquals(oldPrice, other.oldPrice);
  }
  ...
  @override
  String toString() {
    return 'GoodsItemDataDto(sku: $sku, title: $title, productDescription: $productDescription, image: $image, price: $price, oldPrice: $oldPrice)';
  }
}
...
class StoryFavoriteItemAPIDataDto {
  ...
  @override
  String toString() {
    return 'StoryFavoriteItemAPIDataDto(id: $id, imageFilePath: $imageFilePath, backgroundColor: $backgroundColor)';
  }
}
...
class ContentDataDto {
  ...
  @override
  String toString() {
    return 'ContentDataDto(contentType: $contentType, sourceType: $sourceType)';
  }
}
...
class InappstorySdkModuleHostApi {
  ...
  Future<void> initWith(String apiKey, String userID, {bool anonymous = false, String? userSign, String? languageCode, String? languageRegion, String? cacheSize, List<String>? tags, }) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[apiKey, userID, anonymous, userSign, languageCode, languageRegion, cacheSize, tags]);
...
class InAppStoryManagerHostApi {
  ...
  Future<void> addTags(List<String> tags) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.inappstory_plugin.InAppStoryManagerHostApi.addTags$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> removeTags(List<String> tags) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.inappstory_plugin.InAppStoryManagerHostApi.removeTags$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
