...
enum PigeonGeneratedPigeonInternal {
...
enum StoryTypeDto: Int, CaseIterable {
  case cOMMON = 0
  case uGC = 1
  case iAM = 2
  case bANNER = 3
...
enum SourceTypeDto: Int, CaseIterable {
  case sINGLE = 0
  case oNBOARDING = 1
  case lIST = 2
  case fAVORITE = 3
...
enum ClickActionDto: Int, CaseIterable {
  case bUTTON = 0
  case sWIPE = 1
  case gAME = 2
  case dEEPLINK = 3
...
enum CoverQuality: Int, CaseIterable {
  case medium = 0
  case high = 1
}

enum ScrollStyle: Int, CaseIterable {
  case flat = 0
  case cover = 1
  case cube = 2
}

enum PresentationStyle: Int, CaseIterable {
  case zoom = 0
  case modal = 1
  case fade = 2
}

enum ContentTypeDto: Int, CaseIterable {
  case sTORY = 0
  case uGC = 1
  case iNAPPMESSAGE = 2
}

enum InAppMessageTypeDto: Int, CaseIterable {
  case fULLSCREEN = 0
  case bOTTOMSHEET = 1
  case pOPUP = 2
  case tOAST = 3
...
struct StoryAPIDataDto: Hashable, CustomStringConvertible {
  var id: Int64
  ...
  static func == (lhs: StoryAPIDataDto, rhs: StoryAPIDataDto) -> Bool {
    ...
    return PigeonGeneratedPigeonInternal.deepEquals(lhs.id, rhs.id) && PigeonGeneratedPigeonInternal.deepEquals(lhs.storyData, rhs.storyData) && PigeonGeneratedPigeonInternal.deepEquals(lhs.imageFilePath, rhs.imageFilePath) && PigeonGeneratedPigeonInternal.deepEquals(lhs.videoFilePath, rhs.videoFilePath) && PigeonGeneratedPigeonInternal.deepEquals(lhs.hasAudio, rhs.hasAudio) && PigeonGeneratedPigeonInternal.deepEquals(lhs.title, rhs.title) && PigeonGeneratedPigeonInternal.deepEquals(lhs.titleColor, rhs.titleColor) && PigeonGeneratedPigeonInternal.deepEquals(lhs.backgroundColor, rhs.backgroundColor) && PigeonGeneratedPigeonInternal.deepEquals(lhs.opened, rhs.opened) && PigeonGeneratedPigeonInternal.deepEquals(lhs.aspectRatio, rhs.aspectRatio)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("StoryAPIDataDto")
    PigeonGeneratedPigeonInternal.deepHash(value: id, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: storyData, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: imageFilePath, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: videoFilePath, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: hasAudio, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: title, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: titleColor, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: backgroundColor, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: opened, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: aspectRatio, hasher: &hasher)
  }

  public var description: String {
    return "StoryAPIDataDto(id: \(String(describing: id)), storyData: \(String(describing: storyData)), imageFilePath: \(String(describing: imageFilePath)), videoFilePath: \(String(describing: videoFilePath)), hasAudio: \(String(describing: hasAudio)), title: \(String(describing: title)), titleColor: \(String(describing: titleColor)), backgroundColor: \(String(describing: backgroundColor)), opened: \(String(describing: opened)), aspectRatio: \(String(describing: aspectRatio)))"
  }
}

/// Generated class from Pigeon that represents data sent in messages.
struct StoryDataDto: Hashable, CustomStringConvertible {
  var id: Int64
  ...
  func hash(into hasher: inout Hasher) {
    hasher.combine("StoryDataDto")
    PigeonGeneratedPigeonInternal.deepHash(value: id, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: title, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: tags, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: feed, hasher: &hasher)
...
/// Generated class from Pigeon that represents data sent in messages.
struct SlideDataDto: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: SlideDataDto, rhs: SlideDataDto) -> Bool {
    ...
    return PigeonGeneratedPigeonInternal.deepEquals(lhs.story, rhs.story) && PigeonGeneratedPigeonInternal.deepEquals(lhs.index, rhs.index) && PigeonGeneratedPigeonInternal.deepEquals(lhs.payload, rhs.payload)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("SlideDataDto")
    PigeonGeneratedPigeonInternal.deepHash(value: story, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: index, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: payload, hasher: &hasher)
  }

  public var description: String {
    return "SlideDataDto(story: \(String(describing: story)), index: \(String(describing: index)), payload: \(String(describing: payload)))"
  }
}

/// Generated class from Pigeon that represents data sent in messages.
struct GoodsItemAppearanceDto: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: GoodsItemAppearanceDto, rhs: GoodsItemAppearanceDto) -> Bool {
    ...
    return PigeonGeneratedPigeonInternal.deepEquals(lhs.itemBackgroundColor, rhs.itemBackgroundColor) && PigeonGeneratedPigeonInternal.deepEquals(lhs.itemCornerRadius, rhs.itemCornerRadius) && PigeonGeneratedPigeonInternal.deepEquals(lhs.itemMainTextColor, rhs.itemMainTextColor) && PigeonGeneratedPigeonInternal.deepEquals(lhs.itemOldPriceTextColor, rhs.itemOldPriceTextColor) && PigeonGeneratedPigeonInternal.deepEquals(lhs.itemTitleTextSize, rhs.itemTitleTextSize) && PigeonGeneratedPigeonInternal.deepEquals(lhs.itemDescriptionTextSize, rhs.itemDescriptionTextSize) && PigeonGeneratedPigeonInternal.deepEquals(lhs.itemPriceTextSize, rhs.itemPriceTextSize) && PigeonGeneratedPigeonInternal.deepEquals(lhs.itemOldPriceTextSize, rhs.itemOldPriceTextSize) && PigeonGeneratedPigeonInternal.deepEquals(lhs.widgetBackgroundColor, rhs.widgetBackgroundColor) && PigeonGeneratedPigeonInternal.deepEquals(lhs.closeButtonImage, rhs.closeButtonImage) && PigeonGeneratedPigeonInternal.deepEquals(lhs.closeButtonColor, rhs.closeButtonColor) && PigeonGeneratedPigeonInternal.deepEquals(lhs.widgetBackgroundHeight, rhs.widgetBackgroundHeight)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("GoodsItemAppearanceDto")
    PigeonGeneratedPigeonInternal.deepHash(value: itemBackgroundColor, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: itemCornerRadius, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: itemMainTextColor, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: itemOldPriceTextColor, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: itemTitleTextSize, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: itemDescriptionTextSize, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: itemPriceTextSize, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: itemOldPriceTextSize, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: widgetBackgroundColor, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: closeButtonImage, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: closeButtonColor, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: widgetBackgroundHeight, hasher: &hasher)
  }

  public var description: String {
    return "GoodsItemAppearanceDto(itemBackgroundColor: \(String(describing: itemBackgroundColor)), itemCornerRadius: \(String(describing: itemCornerRadius)), itemMainTextColor: \(String(describing: itemMainTextColor)), itemOldPriceTextColor: \(String(describing: itemOldPriceTextColor)), itemTitleTextSize: \(String(describing: itemTitleTextSize)), itemDescriptionTextSize: \(String(describing: itemDescriptionTextSize)), itemPriceTextSize: \(String(describing: itemPriceTextSize)), itemOldPriceTextSize: \(String(describing: itemOldPriceTextSize)), widgetBackgroundColor: \(String(describing: widgetBackgroundColor)), closeButtonImage: \(String(describing: closeButtonImage)), closeButtonColor: \(String(describing: closeButtonColor)), widgetBackgroundHeight: \(String(describing: widgetBackgroundHeight)))"
  }
}

/// Generated class from Pigeon that represents data sent in messages.
struct GoodsItemDataDto: Hashable, CustomStringConvertible {
  var sku: String? = nil
  var title: String? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> GoodsItemDataDto? {
    ...
    let title: String? = nilOrValue(pigeonVar_list[1])
    let productDescription: String? = nilOrValue(pigeonVar_list[2])
  ...
  static func == (lhs: GoodsItemDataDto, rhs: GoodsItemDataDto) -> Bool {
    ...
    return PigeonGeneratedPigeonInternal.deepEquals(lhs.sku, rhs.sku) && PigeonGeneratedPigeonInternal.deepEquals(lhs.title, rhs.title) && PigeonGeneratedPigeonInternal.deepEquals(lhs.productDescription, rhs.productDescription) && PigeonGeneratedPigeonInternal.deepEquals(lhs.image, rhs.image) && PigeonGeneratedPigeonInternal.deepEquals(lhs.price, rhs.price) && PigeonGeneratedPigeonInternal.deepEquals(lhs.oldPrice, rhs.oldPrice)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("GoodsItemDataDto")
    PigeonGeneratedPigeonInternal.deepHash(value: sku, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: title, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: productDescription, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: image, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: price, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: oldPrice, hasher: &hasher)
  }

  public var description: String {
    return "GoodsItemDataDto(sku: \(String(describing: sku)), title: \(String(describing: title)), productDescription: \(String(describing: productDescription)), image: \(String(describing: image)), price: \(String(describing: price)), oldPrice: \(String(describing: oldPrice)))"
  }
}

/// Generated class from Pigeon that represents data sent in messages.
struct StoryFavoriteItemAPIDataDto: Hashable, CustomStringConvertible {
  var id: Int64
  var imageFilePath: String? = nil
  var backgroundColor: String
  ...
  static func == (lhs: StoryFavoriteItemAPIDataDto, rhs: StoryFavoriteItemAPIDataDto) -> Bool {
    ...
    return PigeonGeneratedPigeonInternal.deepEquals(lhs.id, rhs.id) && PigeonGeneratedPigeonInternal.deepEquals(lhs.imageFilePath, rhs.imageFilePath) && PigeonGeneratedPigeonInternal.deepEquals(lhs.backgroundColor, rhs.backgroundColor)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("StoryFavoriteItemAPIDataDto")
    PigeonGeneratedPigeonInternal.deepHash(value: id, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: imageFilePath, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: backgroundColor, hasher: &hasher)
  }
  ...
  public var description: String {
    return "StoryFavoriteItemAPIDataDto(id: \(String(describing: id)), imageFilePath: \(String(describing: imageFilePath)), backgroundColor: \(String(describing: backgroundColor)))"
  }
}

/// Generated class from Pigeon that represents data sent in messages.
struct ContentDataDto: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: ContentDataDto, rhs: ContentDataDto) -> Bool {
    ...
    return PigeonGeneratedPigeonInternal.deepEquals(lhs.contentType, rhs.contentType) && PigeonGeneratedPigeonInternal.deepEquals(lhs.sourceType, rhs.sourceType)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("ContentDataDto")
    PigeonGeneratedPigeonInternal.deepHash(value: contentType, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: sourceType, hasher: &hasher)
  }

  public var description: String {
    return "ContentDataDto(contentType: \(String(describing: contentType)), sourceType: \(String(describing: sourceType)))"
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct InAppMessageDataDto: Hashable, CustomStringConvertible {
  ...
  func hash(into hasher: inout Hasher) {
    hasher.combine("InAppMessageDataDto")
    PigeonGeneratedPigeonInternal.deepHash(value: id, hasher: &hasher)
    PigeonGeneratedPigeonInternal.deepHash(value: title, hasher: &hasher)
