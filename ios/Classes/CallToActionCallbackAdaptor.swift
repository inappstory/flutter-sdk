...
class CallToActionCallbackAdaptor {
    init(binaryMessenger: FlutterBinaryMessenger) {
        ...
        callToActionCallbackFlutterApi = CallToActionCallbackFlutterApi(binaryMessenger: binaryMessenger)
    ...
    private func onActionWith(target: String, type: InAppStorySDK.ActionType, storyType: InAppStorySDK.StoriesType?) {
    ...
    private func mapClickActionDto(arg: InAppStorySDK.ActionType) -> ClickActionDto {
        switch arg {
