...
struct StoryAPIDataDto: Hashable {
  ...
  static func == (lhs: StoryAPIDataDto, rhs: StoryAPIDataDto) -> Bool {
    ...
    return deepEqualsPigeonGenerated(lhs.id, rhs.id) && deepEqualsPigeonGenerated(lhs.storyData, rhs.storyData) && deepEqualsPigeonGenerated(lhs.imageFilePath, rhs.imageFilePath) && deepEqualsPigeonGenerated(lhs.videoFilePath, rhs.videoFilePath) && deepEqualsPigeonGenerated(lhs.hasAudio, rhs.hasAudio) && deepEqualsPigeonGenerated(lhs.title, rhs.title) && deepEqualsPigeonGenerated(lhs.titleColor, rhs.titleColor) && deepEqualsPigeonGenerated(lhs.backgroundColor, rhs.backgroundColor) && deepEqualsPigeonGenerated(lhs.opened, rhs.opened) && deepEqualsPigeonGenerated(lhs.aspectRatio, rhs.aspectRatio)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("StoryAPIDataDto")
    deepHashPigeonGenerated(value: id, hasher: &hasher)
    deepHashPigeonGenerated(value: storyData, hasher: &hasher)
    deepHashPigeonGenerated(value: imageFilePath, hasher: &hasher)
    deepHashPigeonGenerated(value: videoFilePath, hasher: &hasher)
    deepHashPigeonGenerated(value: hasAudio, hasher: &hasher)
    deepHashPigeonGenerated(value: title, hasher: &hasher)
    deepHashPigeonGenerated(value: titleColor, hasher: &hasher)
    deepHashPigeonGenerated(value: backgroundColor, hasher: &hasher)
    deepHashPigeonGenerated(value: opened, hasher: &hasher)
    deepHashPigeonGenerated(value: aspectRatio, hasher: &hasher)
  }
}
...
struct StoryDataDto: Hashable {
  ...
  static func == (lhs: StoryDataDto, rhs: StoryDataDto) -> Bool {
    ...
    return deepEqualsPigeonGenerated(lhs.id, rhs.id) && deepEqualsPigeonGenerated(lhs.title, rhs.title) && deepEqualsPigeonGenerated(lhs.tags, rhs.tags) && deepEqualsPigeonGenerated(lhs.feed, rhs.feed) && deepEqualsPigeonGenerated(lhs.sourceType, rhs.sourceType) && deepEqualsPigeonGenerated(lhs.slidesCount, rhs.slidesCount) && deepEqualsPigeonGenerated(lhs.storyType, rhs.storyType)
  }
  ...
  func hash(into hasher: inout Hasher) {
    ...
    deepHashPigeonGenerated(value: id, hasher: &hasher)
    deepHashPigeonGenerated(value: title, hasher: &hasher)
    deepHashPigeonGenerated(value: tags, hasher: &hasher)
    deepHashPigeonGenerated(value: feed, hasher: &hasher)
    deepHashPigeonGenerated(value: sourceType, hasher: &hasher)
    deepHashPigeonGenerated(value: slidesCount, hasher: &hasher)
    deepHashPigeonGenerated(value: storyType, hasher: &hasher)
  }
}
...
struct SlideDataDto: Hashable {
  ...
  static func == (lhs: SlideDataDto, rhs: SlideDataDto) -> Bool {
    ...
    return deepEqualsPigeonGenerated(lhs.story, rhs.story) && deepEqualsPigeonGenerated(lhs.index, rhs.index) && deepEqualsPigeonGenerated(lhs.payload, rhs.payload)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("SlideDataDto")
    deepHashPigeonGenerated(value: story, hasher: &hasher)
    deepHashPigeonGenerated(value: index, hasher: &hasher)
    deepHashPigeonGenerated(value: payload, hasher: &hasher)
  }
}
...
struct GoodsItemAppearanceDto: Hashable {
  ...
  static func == (lhs: GoodsItemAppearanceDto, rhs: GoodsItemAppearanceDto) -> Bool {
    ...
    return deepEqualsPigeonGenerated(lhs.itemBackgroundColor, rhs.itemBackgroundColor) && deepEqualsPigeonGenerated(lhs.itemCornerRadius, rhs.itemCornerRadius) && deepEqualsPigeonGenerated(lhs.itemMainTextColor, rhs.itemMainTextColor) && deepEqualsPigeonGenerated(lhs.itemOldPriceTextColor, rhs.itemOldPriceTextColor) && deepEqualsPigeonGenerated(lhs.itemTitleTextSize, rhs.itemTitleTextSize) && deepEqualsPigeonGenerated(lhs.itemDescriptionTextSize, rhs.itemDescriptionTextSize) && deepEqualsPigeonGenerated(lhs.itemPriceTextSize, rhs.itemPriceTextSize) && deepEqualsPigeonGenerated(lhs.itemOldPriceTextSize, rhs.itemOldPriceTextSize) && deepEqualsPigeonGenerated(lhs.widgetBackgroundColor, rhs.widgetBackgroundColor) && deepEqualsPigeonGenerated(lhs.closeButtonImage, rhs.closeButtonImage) && deepEqualsPigeonGenerated(lhs.closeButtonColor, rhs.closeButtonColor) && deepEqualsPigeonGenerated(lhs.widgetBackgroundHeight, rhs.widgetBackgroundHeight)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("GoodsItemAppearanceDto")
    deepHashPigeonGenerated(value: itemBackgroundColor, hasher: &hasher)
    deepHashPigeonGenerated(value: itemCornerRadius, hasher: &hasher)
    deepHashPigeonGenerated(value: itemMainTextColor, hasher: &hasher)
    deepHashPigeonGenerated(value: itemOldPriceTextColor, hasher: &hasher)
    deepHashPigeonGenerated(value: itemTitleTextSize, hasher: &hasher)
    deepHashPigeonGenerated(value: itemDescriptionTextSize, hasher: &hasher)
    deepHashPigeonGenerated(value: itemPriceTextSize, hasher: &hasher)
    deepHashPigeonGenerated(value: itemOldPriceTextSize, hasher: &hasher)
    deepHashPigeonGenerated(value: widgetBackgroundColor, hasher: &hasher)
    deepHashPigeonGenerated(value: closeButtonImage, hasher: &hasher)
    deepHashPigeonGenerated(value: closeButtonColor, hasher: &hasher)
    deepHashPigeonGenerated(value: widgetBackgroundHeight, hasher: &hasher)
  }
}
...
struct GoodsItemDataDto: Hashable {
  ...
  static func == (lhs: GoodsItemDataDto, rhs: GoodsItemDataDto) -> Bool {
    ...
    return deepEqualsPigeonGenerated(lhs.sku, rhs.sku) && deepEqualsPigeonGenerated(lhs.title, rhs.title) && deepEqualsPigeonGenerated(lhs.description, rhs.description) && deepEqualsPigeonGenerated(lhs.image, rhs.image) && deepEqualsPigeonGenerated(lhs.price, rhs.price) && deepEqualsPigeonGenerated(lhs.oldPrice, rhs.oldPrice)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("GoodsItemDataDto")
    deepHashPigeonGenerated(value: sku, hasher: &hasher)
    deepHashPigeonGenerated(value: title, hasher: &hasher)
    deepHashPigeonGenerated(value: description, hasher: &hasher)
    deepHashPigeonGenerated(value: image, hasher: &hasher)
    deepHashPigeonGenerated(value: price, hasher: &hasher)
    deepHashPigeonGenerated(value: oldPrice, hasher: &hasher)
  }
}
...
struct StoryFavoriteItemAPIDataDto: Hashable {
  ...
  static func == (lhs: StoryFavoriteItemAPIDataDto, rhs: StoryFavoriteItemAPIDataDto) -> Bool {
    ...
    return deepEqualsPigeonGenerated(lhs.id, rhs.id) && deepEqualsPigeonGenerated(lhs.imageFilePath, rhs.imageFilePath) && deepEqualsPigeonGenerated(lhs.backgroundColor, rhs.backgroundColor)
  }
...
struct ContentDataDto: Hashable {
  ...
  static func == (lhs: ContentDataDto, rhs: ContentDataDto) -> Bool {
    ...
    return deepEqualsPigeonGenerated(lhs.contentType, rhs.contentType) && deepEqualsPigeonGenerated(lhs.sourceType, rhs.sourceType)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("ContentDataDto")
    deepHashPigeonGenerated(value: contentType, hasher: &hasher)
    deepHashPigeonGenerated(value: sourceType, hasher: &hasher)
  }
}
